...
zero = []
for i in range(50):
    fname = '/Users/superpup/Documents/edxpython/Module5LR/recordings/0_jackson_%d.wav' % i
...
#
X_test_size = int(Provided_Portion * n_audio_samples)
X_test = test[:X_test_size]
...
#
y_test = test[X_test_size:]
assert len(X_test) + len(y_test) == n_audio_samples
...
#
X_train = train[:, :X_test_size]
y_train = train[:, X_test_size:]
#print X_train.shape
#print y_train.shape
...
print "Extrapolation R^2 Score: ", score # 0.0 (!!!)
