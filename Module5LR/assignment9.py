...
#
# .. your code here ..
X = pd.read_csv('/Users/superpup/Documents/edxpython/Module5LR/Datasets/College.csv', index_col=0)
...
X_train, X_test, y_train, y_test = train_test_split(rb, accept, test_size=0.3, random_state=7)
...
from sklearn.cross_validation import train_test_split
X_train, X_test, y_train, y_test = train_test_split(fail, accept, test_size=0.3, random_state=7)
...
from sklearn.cross_validation import train_test_split
X_train, X_test, y_train, y_test = train_test_split(rbe, accept, test_size=0.3, random_state=7)
