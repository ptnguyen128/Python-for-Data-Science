...
#
# .. your code here ..
mat = scipy.io.loadmat('/Users/superpup/Documents/edxpython/Module4/Isomap/Datasets/face_data.mat')
...
#
# .. your code here ..
face_labels = pd.read_csv('/Users/superpup/Documents/edxpython/Module5KNN/Datasets/face_labels.csv',header=None)
face_labels.columns = ['label']
label = face_labels['label'].copy()
...
data_train, data_test, label_train, label_test = train_test_split(T, label, test_size = 0.15, random_state=7)
