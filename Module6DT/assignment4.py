...
#
# .. your code here ..
X = pd.read_csv('/Users/superpup/Documents/edxpython/Module6SVC/Datasets/wheat.data', index_col=0, header=0)
...
#
# .. your code here ..
map_label = {'canadian':0, 'kama':1, 'rosa':2}
X['wheat_type'] = X['wheat_type'].map(map_label)
y = X['wheat_type'].copy()
...
benchmark(dtree, 'DTree')
drawPlots(dtree, 'DTree')
