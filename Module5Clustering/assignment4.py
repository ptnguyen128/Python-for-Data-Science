...
#  ax.scatter(data, marker = '.', alpha=0.3)
...
#  ax.scatter(centroids[:,0],centroids[:,1], marker='x', c='red', alpha=0.5, linewidths=3, s=169)
  return centroids, model.labels_
...
#
# .. your code here ..
df = pd.read_csv('/Users/superpup/Documents/edxpython/Module5Clustering/Datasets/wholesale.csv')
